  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        "paper-surface": "rgb(var(--paper-surface-rgb) / <alpha-value>)",
        "paper-deep": "rgb(var(--paper-deep-rgb) / <alpha-value>)",
        ink: "rgb(var(--ink-rgb) / <alpha-value>)",
        "ink-muted": "rgb(var(--ink-muted-rgb) / <alpha-value>)",
        ochre: "rgb(var(--accent-ochre-rgb) / <alpha-value>)",
        pine: "rgb(var(--verified-pine-rgb) / <alpha-value>)",
        brick: "rgb(var(--flag-brick-rgb) / <alpha-value>)",
